using MauiApp_MonterosVallejo.Repositories;
using System;
...
using static MauiApp_MonterosVallejo.WeatherModels.WeatherModels;

namespace MauiApp_MonterosVallejo.ViewModels
{
